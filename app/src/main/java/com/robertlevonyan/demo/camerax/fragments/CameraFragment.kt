...
class CameraFragment : BaseFragment<FragmentCameraBinding>(R.layout.fragment_camera) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.run {
            ...
            btnFlash.setOnClickListener { clickFlesh() }
...
//        }
    ...
    fun toggleCamera() = binding.btnSwitchCamera.toggleButton(
        ...
        rotationAngle = 180f,
        firstIcon = R.drawable.ic_exchange,
        secondIcon = R.drawable.ic_exchange,
    ) {
        lensFacing = if (it) {
...
//        binding.llFlashOptions.visibility == View.VISIBLE -> binding.llFlashOptions.circularClose(binding.btnFlash)
    ...
    private fun playClickSound() {
        binding.captureHide.isVisible = true
        viewLifecycleOwner.lifecycleScope.launch {
            delay(50)
            binding.captureHide.isVisible = false
        }
        if (clickMP != null) {
            clickMP!!.release()
        }
